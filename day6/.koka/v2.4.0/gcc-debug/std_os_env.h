...
static inline kk_std_core__list kk_std_os_env_get_argv(kk_context_t* _ctx) { /* () -> ndet list<string> */ 
  kk_box_t _x469;
  kk_std_core__delayed _x470 = kk_std_core__delayed_dup(kk_std_os_env_argv); /*delayed<ndet,list<string>>*/
  _x469 = kk_std_core_force(_x470, _ctx); /*1001*/
  return kk_std_core__list_unbox(_x469, _ctx);
}
